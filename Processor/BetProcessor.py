...
def check_closures_and_race_times():
    ...
    try:
        ...
        print("File './Monitor/data.json' not found.")
        return
    except json.JSONDecodeError:
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file(
                './Monitor/gmailcreds.json', ['https://www.googleapis.com/auth/gmail.readonly'])
...
def clear_processed():
    ...
    try:
        ...
        print(f"Error reading or writing to ./Monitor/data.json: {e}")

class DataUpdater:
    def __init__(self, app):
        self.app = app
        self.file_lock = threading.Lock()
        self.data_file_path = './Monitor/data.json'
...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.iconbitmap('./Monitor/splash.ico')
        self.tk.call('source', './Monitor/Forest-ttk-theme-master/forest-light.tcl')
        ...
        image = Image.open('./Monitor/splash.ico')
