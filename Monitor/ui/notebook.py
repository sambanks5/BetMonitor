...
class Notebook:
    ...
    def initialize_ui(self):
        ...
        self.notebook.place(x=238, y=655, width=500, height=265)
        ...
        self.staff_feed = tk.Text(tab_1, font=("Helvetica", 10), spacing1=2 , bd=0, wrap='word', padx=2, pady=2, fg="#000000", bg="#ffffff")
        ...
        self.factoring_tree.column("D", width=50, stretch=tk.NO)
        self.factoring_tree.column("E", width=50, stretch=tk.NO)
        self.factoring_tree.column("F", width=42, stretch=tk.NO)
        ...
        self.freebet_tree.column("C", width=94, stretch=tk.NO)
        self.freebet_tree.column("E", width=75, stretch=tk.NO)
        self.freebet_tree.column("F", width=42, stretch=tk.NO)
        ...
        self.popup_tree.column("A", width=200, stretch=tk.NO)
